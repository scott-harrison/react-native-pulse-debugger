...
import { RefreshCw, Network, Terminal, Activity } from 'lucide-react';
        ...
        {state === 'connected' ? (
          <div className="px-4 py-2">
            <div className="flex items-center gap-2 text-zinc-500">
              ...
              <div className="text-[10px] font-medium">Connected</div>
            </div>
          </div>
        ) : (
          <div className="px-4 py-2">
            <div className="flex items-center gap-2 text-zinc-500">
              ...
              <div className="text-[10px] font-medium">Disconnected</div>
            </div>
          </div>
        )}
