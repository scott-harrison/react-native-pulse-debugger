...
PulseDebugger.getInstance().configure({
  monitoring: {
    redux: true,
    network: true,
    console: true,
...
const Debugger = () => {
  ...
  const handleTestNetwork = async (isSlow = false) => {
    try {
      ...
      addLog(`Network request failed: ${error instanceof Error ? error.message : String(error)}`);
    }
  };
    ...
    <View style={styles.container}>
      <View style={styles.headerCard}>
        <View style={styles.headerContent}>
          ...
          <View style={[styles.status, statusStyles[isConnected ? 'connected' : 'disconnected']]}>
      ...
      <View style={styles.counterContainer}>
        ...
        <View style={styles.counterActions}>
          ...
          >
            <Text style={[styles.counterButtonText, { color: '#1976D2' }]}>+5</Text>
          </Pressable>

          <Pressable
            style={[styles.counterButton, styles.textButton, { backgroundColor: '#E1F5FE' }]}
            onPress={handleIncrementAsync}
          >
            <Text style={[styles.counterButtonText, { color: '#0288D1' }]}>Async</Text>
          </Pressable>
        </View>
      </View>
      ...
      <View style={styles.actionsContainer}>
        ...
        <View style={styles.actionGroup}>
          ...
          <Pressable style={[styles.actionButton, styles.errorButton]} onPress={handleTestError}>
