...
const SessionsWindow: React.FC<SessionsWindowProps> = ({ onClose }) => {
    ...
    return (
        <motion.div
            ...
            className="flex flex-col max-h-2/3 items-start relative inset-0 backdrop-blur-xl bg-gray-900/80 rounded-lg border border-gray-800/50 p-6 w-4/5 max-w-4xl overflow-hidden"
        >
