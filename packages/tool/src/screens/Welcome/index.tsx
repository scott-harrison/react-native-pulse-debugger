		...
		<div className="relative flex flex-col items-center justify-center h-full bg-gradient-to-b from-gray-900 to-purple-950 text-white">
			...
			<div className="flex flex-col items-center justify-center relative z-50">
				...
				{sessions.length === 0 ? (
					...
					<div className="max-h-[60vh] overflow-y-auto w-full max-w-6xl">
						<div className="flex flex-col gap-4 p-4">
							{sessions.map(session => (
								<div
									key={session.sessionId}
									className="bg-gray-800/25 backdrop-blur-xs rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow border border-gray-500/5 duration-300"
								>
